...
projectbox1.addEventListener('click', function () {
  window.location.href = 'https://github.com/PrasadLegend/Pricing-Panel';
});

projectbox2.addEventListener('click', function () {
  window.location.href = 'https://github.com/PrasadLegend/Score-Keeper';
});

projectbox3.addEventListener('click', function () {
  window.location.href = 'https://github.com/PrasadLegend/N-Puzzle-Solver';
});
